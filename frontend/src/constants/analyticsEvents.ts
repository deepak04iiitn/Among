// MIRRORED — keep in sync with backend/src/constants/analyticsEvents.ts
/**
 * analyticsEvents.ts — Frontend analytics event type constants.
 *
 * PRD §18 rules:
 *  - Never include Firebase UID, email, or raw accountId in event payloads.
 *  - Events are fire-and-forget — never block user-facing actions.
 */
